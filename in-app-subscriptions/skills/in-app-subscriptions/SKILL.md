...
| Situation | Read |
|---|---|
| Products don't exist yet, or don't come back from a query | `references/store-setup.md` |
| Writing the purchase flow on iOS | `references/ios-storekit2.md` |
| Writing the purchase flow on Android | `references/android-play-billing.md` |
| Flutter app | `references/flutter.md` |
| React Native or Expo app | `references/react-native.md` |
| Any backend, any language | `references/backend-verification.md` |
| Renewals, refunds, cancellations, grace periods | `references/store-notifications.md` |
| Considering RevenueCat / Adapty / a billing vendor | `references/vendor-vs-diy.md` |
| Connecting subscription revenue to ad campaigns | `references/attribution-mmp.md` |
| Nothing works in sandbox and nobody knows why | `references/testing-and-debugging.md` |
