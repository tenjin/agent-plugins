...
- **Product setup in both consoles is still yours.** See [store-setup.md](store-setup.md).
...
[attribution-mmp.md](attribution-mmp.md) for the fields to send, a worked example, and the mistakes that
